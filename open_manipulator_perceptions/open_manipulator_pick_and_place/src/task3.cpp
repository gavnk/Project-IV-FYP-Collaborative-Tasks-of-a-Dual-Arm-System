...
int main(int argc, char** argv) {
  ...
  group_dual_grippers.setMaxVelocityScalingFactor(0.1);
  left_gripper_group.setMaxVelocityScalingFactor(0.1);
  right_gripper_group.setMaxVelocityScalingFactor(0.1);
  //std::vector<double> joint_group_positions;
